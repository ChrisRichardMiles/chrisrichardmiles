...
cfg = {
    "script_name": 'opt_lgb_stacking_op_162',
    ...
    "neptune_description": 'p13 second run, using 75 top columns to encode instead of 25 as before plus real_vol_ratio',
...
def main(): 
    ...
    for fold in range(5):
        ...
        top_features.append(get_top_features(model, n_features=75))
