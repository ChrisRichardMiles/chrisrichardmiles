# AUTOGENERATED! DO NOT EDIT! File to edit: ../../projects/m5/05_training_day_by_day_models.ipynb.

# %% auto 0
__all__ = ['FINAL_CFG', 'DICT_FEATURES', 'load_cfg', 'prep_data', 'neptune', 'lgb_daily', 'cli_lgb_daily']

# %% ../../projects/m5/05_training_day_by_day_models.ipynb 2
import os
import logging
import collections
import gc
...
# %% ../../projects/m5/05_training_day_by_day_models.ipynb 8
def prep_data(cfg): 
...
# %% ../../projects/m5/05_training_day_by_day_models.ipynb 9
def neptune(cfg): 
    """Not implemented"""
    if os.getenv('NEPTUNE_API_KEY'): 
        pass

# %% ../../projects/m5/05_training_day_by_day_models.ipynb 11
